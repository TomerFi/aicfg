...
def link(source: str, targets: list[str], dry_run: bool = False, verbose: bool = False) -> None:
    ...
    for target in targets:
        ...
        for category in Category:
            ...
            if category == Category.instructions:
                _link_file(source_path, target_path, dry_run, verbose)
            else:
                _link_dir(source_path, target_path, dry_run, verbose)
...
def _link_file(source_path: Path, target_path: Path, dry_run: bool, verbose: bool) -> None:
...
def _link_dir(source_path: Path, target_path: Path, dry_run: bool, verbose: bool) -> None:
